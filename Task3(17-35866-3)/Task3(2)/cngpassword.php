...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
 ...
 Current  Password: 
  ...
  <span class="error">*  required field <?php echo $currpasswordErr;?></span>
  <br><br>

  New Password:
  <input type="text" name="new password" value="<?php echo $newpassword;?>">
  <span class="error">* required field <?php echo $newpasswordErr;?></span>
  <br><br>
  Retype New Password:
  <input type="text" name="retype new password" value="<?php echo $retypenewpassword;?>">
  <span class="error">*  required field <?php echo $retypenewpasswordErr;?></span>
  <br><br>
